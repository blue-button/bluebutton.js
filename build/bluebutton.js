...
var Codes = function () {
  ...
  var raceAndEthnicity = function (code) {
    var map = {
      'system': 'Race & Ethnicity - CDC',
...
var Demographics = function () {
  ...
  var processCCDA = function (xmlDOM) {
    ...
    data.gender = Codes.gender(el.tag('administrativeGenderCode').attr('code'));
    ...
    data.ethnicity = patient.tag('ethnicGroupCode').attr('code');
    data.religion = patient.tag('religiousAffiliationCode').attr('code');
