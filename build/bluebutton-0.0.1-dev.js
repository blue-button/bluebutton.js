...
var Core = function() {
  ...
  return{parseXML:parseXML, getElementByTagAttrValue:getElementByTagAttrValue, getSection:getSection, date:date}
}();
var Allergies = function() {
  var templateId = "";
  var process = function(xmlDOM) {
    var data = [];
    data.push({date:{value:Core.date("20090909"), low:Core.date("20090902"), high:Core.date("20100103")}, observation_date:{low:Core.date("20110215")}, name:"drug allergy", code:"416098002", code_system:"2.16.840.1.113883.6.96", code_system_name:"SNOMED CT", reaction_type:{name:"Adverse reaction to substance", code:"282100009", code_system:"2.16.840.1.113883.6.96", code_system_name:"SNOMED CT"}, allergen:{name:"ALLERGENIC EXTRACT, PENICILLIN", code:"314422", code_system:"2.16.840.1.113883.6.88", 
    code_system_name:"RxNorm"}, status:"active", reaction:{date:{low:"20090711"}, name:"Hives", code:"247472004", code_system:"2.16.840.1.113883.6.96"}, severity:"moderate to severe"});
    return data
  };
...
var Demographics = function() {
  var templateId = "";
  var process = function(xmlDOM) {
    var data = {name:{prefix:"Mr.", given:["Adam", "Frankie"], family:"Everyman"}, dob:Core.date("19541125"), gender:"male", marital_status:"married", address:{street:["17 Daws Rd.", "Apt 102"], city:"Blue Bell", state:"MA", country:"US", zip:"02368"}, phone:{home:["555-555-1212"], work:["555-555-2323"], mobile:["555-555-3434", "555-555-4545"]}, email:"adam@email.com", race:"white", ethnicity:"Not Hispanic or Latino", religion:"Christian (non-Catholic, non-specific)", guardian:{name:{given:["Ralph", 
...
var Labs = function() {
  ...
  var process = function(xmlDOM) {
    var data = [];
    data.push({name:"CBC WO DIFFERENTIAL", code:"43789009", code_system:"2.16.840.1.113883.6.96", code_system_name:"SNOMED CT", results:[{date:Core.date("200003231430"), name:"WBC", value:6.7, unit:"10+3/ul", code:"33765-9", code_system:"2.16.840.1.113883.6.1", code_system_name:"LOINC", reference:{low:4.3, high:10.8}}]});
    return data
  };
  return{process:process}
}();
var Medications = function() {
  ...
  var process = function(xmlDOM) {
    var data = [];
    data.push({effective_time:{low:Core.date("20110301"), high:Core.date("20120301")}, product:{name:"Albuterol 0.09 MG/ACTUAT inhalant solution", code:"329498", code_system:"2.16.840.1.113883.6.88", translation:{name:"Proventil 0.09 MG/ACTUAT inhalant solution", code:"573621", code_system:"2.16.840.1.113883.6.88", code_system_name:"RxNorm"}}, dose_quantity:1, rate_quantity:{value:90, unit:"ml/min"}, precondition:{name:"Wheezing", code:"56018004", code_system:"2.16.840.1.113883.6.96"}, reason:{name:"Bronchitis", 
    code:"32398004", code_system:"2.16.840.1.113883.6.96"}, route:{name:"RESPIRATORY (INHALATION)", code:"C38216", code_system:"2.16.840.1.113883.3.26.1.1", code_system_name:"NCI Thesaurus"}, vehicle:{name:"Diethylene Glycol", code:"5955009", code_system:"2.16.840.1.113883.6.96", code_system_name:"SNOMED CT"}, administration:{name:"INHALANT", code:"C42944", code_system:"2.16.840.1.113883.3.26.1.1", code_system_name:"NCI Thesaurus"}, prescriber:{organization:"Good Health Clinic", person:"Dr. Robert Michaels"}});
    return data
  };
  return{process:process}
}();
var Plan = function() {
  ...
  var process = function(xmlDOM) {
    var data = [];
    data.push({date:Core.date("20000421"), name:"Colonoscopy", code:"310634005", code_system:"2.16.840.1.113883.6.96"});
    return data
  };
  return{process:process}
}();
var Problems = function() {
  ...
  var process = function(xmlDOM) {
    var data = [];
    data.push({date:{from:Core.date("199803"), to:Core.date("199803")}, name:"Pneumonia", status:"Active", age:57, code:"233604007", code_system:"2.16.840.1.113883.6.96"});
    return data
  };
  return{process:process}
}();
var Procedures = function() {
  ...
  var process = function(xmlDOM) {
    var data = [];
    data.push({date:Core.date("20110215"), name:"Colonic polypectomy", code:"274025005", code_system:"2.16.840.1.113883.6.96", specimen:{name:"colonic polyp sample", code:"309226005", code_system:"2.16.840.1.113883.6.96"}, performer:{organization:"Good Health Clinic", street:["17 Daws Rd."], city:"Blue Bell", state:"MA", zip:"02368", country:"US", phone:"555-555-1234"}, participant:{name:"Colonoscope", code:"90412006", code_system:"2.16.840.1.113883.6.96"}});
    return data
  };
  return{process:process}
}();
